package com.example.recommendedarch.common.dataAccess.local
...
class FakeFirebaseAuth {
    private val _remoteUser = FirebaseUser(
        "1a9n9t0",
        ("https://firebasestorage.googleapis.com/v0/b/alain-nicolas-tello-ee2dd." +
                "appspot.com/o/Cursos%20ANT%20Cover.jpg?alt=media&token=5c1b3dac-be98-4106-87ac-dabc64d64eba").toUri(),
        "Cursos ANT",
        "alain@cursos.ant",
        "+52 555 892 7731",
        "cursosant",
